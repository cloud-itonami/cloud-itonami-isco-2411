(ns accounting.advisor
  "AccountingAdvisor — proposes an accounting operation (reconcile a
  ledger, prepare a financial statement, submit a tax filing, transfer
  client funds) for a registered client. The advisor is swappable:
  ...
  and has no notion of client provenance or tax-filing/fund-transfer
  risk; `accounting.governor` is the independent system that decides
  whether the proposal may proceed, per the itonami actor pattern.

  A proposal is a map:
    {:op :reconcile|:prepare|:submit-tax-filing|:transfer-client-funds
...
(def ^:private system-prompt
  "You are an accounting advisor. Given an accounting operation
